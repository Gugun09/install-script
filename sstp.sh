...
wget -O /etc/accel-ppp.conf "https://quenssh.herokuapp.com/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://quenssh.herokuapp.com/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://quenssh.herokuapp.com/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://quenssh.herokuapp.com/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://quenssh.herokuapp.com/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
