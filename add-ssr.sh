...
echo -e " IP            : ${IP}" | lolcat
echo -e " Port          : ${ssr_port}" | lolcat
echo -e " Password      : ${ssr_password}" | lolcat
echo -e " Encryption    : ${ssr_method}" | lolcat
echo -e " Protocol      : ${Red_font_prefix}${ssr_protocol}" | lolcat
echo -e " Obfs          : ${Red_font_prefix}${ssr_obfs}" | lolcat
echo -e " Device limit  : ${ssr_protocol_param}" | lolcat
echo -e " Expired On    : ${exp} " | lolcat
echo -e " ===================================================" | lolcat
echo -e " Link SSR      : ${ssr_link}" | lolcat
echo -e " ===================================================" | lolcat
