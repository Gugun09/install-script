...
echo -e "\e[032;1mPort $tls1 modified successfully\e[0m" | lolcat
else
echo "Port $tls1 is used" | lolcat
fi
;;
2)
echo "Input Only 2 Character (eg : 69)" | lolcat
...
echo -e "\e[032;1mPort $none1 modified successfully\e[0m" | lolcat
else
echo "Port $none1 is used" | lolcat
fi
;;
x)
exit
