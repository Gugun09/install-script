...
clear
	...
	echo -e "Port OBFS TLS  : $tls" | lolcat
	echo -e "Port OBFS HTTP : $http" | lolcat
	echo -e "Password       : $user" | lolcat
	echo -e "Method         : aes-256-cfb" | lolcat
	echo -e "Expired On     : $exp" | lolcat
	echo -e "===========================" | lolcat
	echo -e "Link OBFS TLS  : $linkss1" | lolcat
	echo -e "===========================" | lolcat
	echo -e "Link OBFS HTTP : $linkss2" | lolcat
	echo -e "===========================" | lolcat
