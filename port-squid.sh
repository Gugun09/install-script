...
echo -e "======================================" | lolcat
echo -e ""
echo -e "     [1]  Change Port $sqd" | lolcat
echo -e "     [2]  Change Port $sqd2" | lolcat
...
echo -e "\e[032;1mPort $squid modified successfully\e[0m" | lolcat
else
...
echo "Port $squid is used" | lolcat
fi
;;
x)
exit
